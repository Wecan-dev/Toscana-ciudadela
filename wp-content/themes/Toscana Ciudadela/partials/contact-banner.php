<section class='main-quick-form'>
  ...
  <form class="main-quick-form__form" method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_9_" class="_form _form_9 _inline-form  _dark" novalidate>
    <div>
