<section class='main-form' id='contacto'>
  ...
  <div class='main-form__form'>
    <form method="POST" action="https://nivel.activehosted.com/proc.php" id="_form_19_" class="_form _form_19 _inline-form  _dark" novalidate style="width: 100%;">
     <h3>
    ...
    <div class='row _form-content'>
      ...
      <div class="_form_element _field4 _full_width col-lg-12 col-md-12 col-xs-12" >
        <div class="_row">
          <label class="_form-label">
        ...
        <div class="_row _checkbox-radio">
          ...
          <span>
            <label for="field_4Acepto" style="color: white;font-size:12px;">
      ...
      <div class="_button-wrapper _full_width col-lg-12 col-md-12 col-xs-12">
        <button id="_form_19_submit" class="_submit  btn btn-submit btn-submit-white" type="submit">
          Enviar
        </button>
      </div>
    </div>
